package com.hivesandcolonies.polen.item.spawn;
...
public class UniquePolenSpawnEggItem extends DeferredSpawnEggItem {
    private static final Component ALREADY_EXISTS_MESSAGE = Component.translatable("item.polen.polen_spawn_egg.already_exists")
