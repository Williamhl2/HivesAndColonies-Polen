...
public class PolenIdleHobbyGoal extends Goal {
    ...
    private String dialogueSituation = com.hivesandcolonies.characters.character.polen.dialogue.PolenDialogueManager.AMBIENT_DRAWING;
    ...
    public boolean canContinueToUse() {
        return this.activityTicks > 0
                ...
                || com.hivesandcolonies.characters.character.polen.entity.ai.brain.routine.PolenRoutinePlanner.isNearRestingSpot(this.polen));
    }
    ...
    public void stop() {
        ...
        this.dialogueSituation = com.hivesandcolonies.characters.character.polen.dialogue.PolenDialogueManager.AMBIENT_DRAWING;
    }
