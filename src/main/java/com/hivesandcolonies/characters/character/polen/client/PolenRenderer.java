...
import com.hivesandcolonies.characters.character.polen.client.model.PolenModel;
import com.hivesandcolonies.characters.character.polen.client.layer.PolenAffinityCharmLayer;
...
public class PolenRenderer extends MobRenderer<PolenEntity, PolenModel> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Characters.MODID, "textures/entity/polen.png");
