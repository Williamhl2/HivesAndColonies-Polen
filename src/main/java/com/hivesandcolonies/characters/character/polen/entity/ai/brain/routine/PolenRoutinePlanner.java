package com.hivesandcolonies.characters.character.polen.entity.ai.brain.routine;
...
public final class PolenRoutinePlanner {
    ...
    public static BlockPos findLightMagicTarget(PolenEntity polen) {
        ...
        if (target != null && target.type() == com.hivesandcolonies.characters.character.polen.entity.ai.world.affordance.PolenAffordanceType.MAGIC_LIGHT) {
