package com.hivesandcolonies.characters.character.polen.item.meta;
...
public final class PolenItemTags {
    ...
    private static TagKey<Item> create(String path) {
        return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(Characters.MODID, path));
    }
}
