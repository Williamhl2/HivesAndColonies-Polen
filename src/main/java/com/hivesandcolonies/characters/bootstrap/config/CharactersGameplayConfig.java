package com.hivesandcolonies.characters.bootstrap.config;

import net.neoforged.neoforge.common.ModConfigSpec;

public final class CharactersGameplayConfig {
    ...
    static {
        ...
        ENABLE_SECONDARY_CHARACTER_SPAWN_EGGS = builder
                .comment(
                        "Enables spawn eggs and related creative-tab content for non-Polen characters.",
    ...
    private CharactersGameplayConfig() {
    }
