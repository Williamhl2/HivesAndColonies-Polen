...
import com.hivesandcolonies.characters.entity.ai.expression.activity.PolenQuietActivityController;
import com.hivesandcolonies.characters.entity.ai.brain.action.PolenAutonomousActionPlan;
...
public class PolenIdleHobbyGoal extends Goal {
    ...
    private String dialogueSituation = com.hivesandcolonies.characters.dialogue.PolenDialogueManager.AMBIENT_DRAWING;
    ...
    public boolean canContinueToUse() {
        return this.activityTicks > 0
                ...
                || com.hivesandcolonies.characters.entity.ai.brain.routine.PolenRoutinePlanner.isNearRestingSpot(this.polen));
    }
    ...
    public void stop() {
        ...
        this.dialogueSituation = com.hivesandcolonies.characters.dialogue.PolenDialogueManager.AMBIENT_DRAWING;
    }
