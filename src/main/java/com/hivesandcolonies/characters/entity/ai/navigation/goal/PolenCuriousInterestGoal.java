    ...
    public void start() {
        ...
        if (this.target.type() == PolenInterestType.SOURCE) {
            ...
            PolenAmbientDialogueController.tryPlay(
                    this.polen,
                    com.hivesandcolonies.characters.dialogue.PolenDialogueManager.AMBIENT_MAGIC
            );
        } else {
            this.polen.rememberInterestingSpot(this.target.pos());
            PolenAmbientDialogueController.tryPlay(
                    this.polen,
                    com.hivesandcolonies.characters.dialogue.PolenDialogueManager.AMBIENT_CURIOSITY
            );
        }
