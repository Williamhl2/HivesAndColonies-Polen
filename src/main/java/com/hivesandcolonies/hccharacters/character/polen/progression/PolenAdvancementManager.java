...
public final class PolenAdvancementManager {
    ...
    public static final ResourceLocation ROOT =
            ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, "story/root");

    public static final ResourceLocation FIRST_MEETING =
            ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, "story/first_meeting");

    public static final ResourceLocation FIRST_TRUST =
            ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, "story/first_trust");

    public static final ResourceLocation NAME_REVEAL =
            ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, "story/name_reveal");
    ...
    public static final ResourceLocation PLAYER_HAS_SHELTER =
        ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, "story/player_has_shelter");
