...
public final class PolenInterestLocator {
    ...
    private static boolean shouldNoticeLightInterest(PolenEntity polen) {
        return shouldPreferLightInterest(polen)
                || polen.getMood() == com.hivesandcolonies.hccharacters.character.polen.entity.ai.brain.mood.PolenMood.CURIOUS
                || polen.getMood() == com.hivesandcolonies.hccharacters.character.polen.entity.ai.brain.mood.PolenMood.INSPIRED
                || polen.getMood() == com.hivesandcolonies.hccharacters.character.polen.entity.ai.brain.mood.PolenMood.JOYFUL
                || polen.getMood() == com.hivesandcolonies.hccharacters.character.polen.entity.ai.brain.mood.PolenMood.CONFIDENT;
    }
