package com.hivesandcolonies.hccharacters.character.polen.item.spawn;
...
public class UniquePolenSpawnEggItem extends DeferredSpawnEggItem {
    private static final Component ALREADY_EXISTS_MESSAGE = Component.translatable("item.hc_characters.polen_spawn_egg.already_exists")
