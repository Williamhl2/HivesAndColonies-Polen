package com.hivesandcolonies.hccharacters.character.polen.entity.ai.world.identity;
...
public enum PolenAffinity {
    ...
    PolenAffinity(PolenInterest interest, String itemPath) {
        ...
        this.itemId = ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, itemPath);
    }
