package com.hivesandcolonies.hccharacters.character.befsh.client;

import com.hivesandcolonies.hccharacters.bootstrap.HcCharacters;
import com.hivesandcolonies.hccharacters.character.befsh.client.model.BefshModel;
...
public class BefshRenderer extends MobRenderer<BefshEntity, BefshModel> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HcCharacters.MODID, "textures/entity/befsh.png");
